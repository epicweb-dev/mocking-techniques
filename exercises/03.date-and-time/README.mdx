...
This is where mocking comes in handy. While you can, technically, replace the `Date` constructor and make it return a fixed date, there are a far nicer APIs provided in Vitest to work date and time.
