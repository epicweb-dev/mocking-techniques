...
Ideally, testing functions should come down to the I/O (input/output) testing. You provide a function with the right input and assert the expected output. That kind of testing is extremely apparent in unit testing and it truly shines with pure functions.
...
1. Substituting the implementation;
1. Creating "dummies" for the tested code's arguments.

In this exercise, you will learn how to wield all three and also see the use cases for different kinds of function mocks.
