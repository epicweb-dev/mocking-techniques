...
👨‍💼 Your task is to write the test for the `logRequest` function to make sure it prints the right messages to the console. And to do that, you will be spying on `console.log` in test!
